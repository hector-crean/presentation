<script lang="ts">
    ...
    import DrawnSvg from "$lib/components/DrawnSvg.svelte";
    import IntersectionObserver from "$lib/components/IntersectionObserver.svelte";
    import ScrollCorridor from "$lib/components/ScrollCorridor.svelte";
    import Typewriter from "$lib/components/Typewriter.svelte";
    import Article from "./Article.layout.svelte";
...
<Article>
    <section data-fullbleed="true">
        ...
        had undertaken an ambitious transformation at the most significant
        moment in the company’s history — at the height of the COVID-19
        pandemic. As a result, they have reclaimed their role as trailblazing
        scientific researchers, makers, and doers with a bold and confident
        outlook: the new Pfizer is not only treating difficult diseases —
        they’re curing them. To mark this evolution, Pfizer enlisted Team to
        create a new identity that celebrated its storied history, while
        signaling a new chapter for the company from scientific fast follower to
        innovative science leader.
    </section>
    <section>
        Pfizer is among the world’s largest pharmaceutical companies and one of
        the most recognizable brands across all industries. After more than 170
...
<ScrollCorridor let:progressionRatio>
    <section id="exitpoint">
        <IntersectionObserver let:intersecting>
